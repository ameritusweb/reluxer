...
public partial class ConditionalTest : MinimactComponent
{
    ...
    protected override VNode Render()
    {
        ...
        }) : new VNull("1.3"), (new MObject(myState1)) ? new VElement("div", "1.4.1", new Dictionary<string, string> { ["class"] = "active" }, "Active State") : new VElement("div", "1.4.2", new Dictionary<string, string> { ["class"] = "inactive" }, "Inactive State"), new VElement("button", "1.5", new Dictionary<string, string> { ["onclick"] = "Handle1" }, "Toggle myState1"));
    }
